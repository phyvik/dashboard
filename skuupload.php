                                ...
                                <form role='form' method='POST' enctype='multipart/form-data' name='skuform'>
                                    <div class='form-group'>
                                        ...
                                        <div class='form-group'>
                                            ...
                                            <select class='form-control' id='name_meals' name='mealtype'
                                                    onChange='checkmeal();'>
                                    ...
                                    <div class='form-group' id='stdmeals' style='display:none'>
                                        ...
                                        <div class='form-group'>
                                            <label> Enter Comma Seperated meal items</label>
                                            <textarea required name='stdmealdata'
                                                      id="stdmealdata"
                                                      class='form-control'
                                                      rows='3'>
                </textarea>
                                    ...
                                    <div class='form-group' id='splmeals' style='display:none'>
                                        ...
                                        <div class='form-group'>
                                            <label>Enter Special Meal Name</label>
                                            <input class='form-control' required id="splmeal_name" name='splmeal_name'
                                                   type='textarea' placeholder='Speacial Meal Name'/>
                                        </div>


                                        <label> Enter Comma Seperated Special meal </label>
                                        <textarea required name='spmealitems' id="splmealdata" class='form-control'
                                                  rows='3'> </textarea>
                                    </div>
                                    ...
                                    <div class='form-group'>
                                        ...
                                        <input class='form-control' required id="meals_origin" name='meals_origin'
                                               type='textarea' placeholder='North / South Indian Meals'/>
                                    </div>
                                    ...
                                    <div class='form-group'>
                                        ...
                                        <input type='file' id='mealimage' name='mealimage' onchange="readURL(this);"
                                               required>
                                    </div>
        ...
        <div class='row mx-auto' id='demo' style='display:none;'>
            ...
            <div class="row mx-auto">
                <div class="col-md-3 g-py-20 mx-auto">
                    ...
                    <h2 class="text-uppercase"
                        style='font-size: 20px;font-weight: bold;margin-top:  10px;text-align: center;'
                        id='demotxt'></h2>
                    <div>
                        <a href="#">
            ...
            <div class="card mx-auto col-lg-12">
                <div class="card-header">
                    <i class="fa fa-table"></i> Preview of given input
                </div>
                <div class="card-body">
                                    ...
                                    <table class="table table-bordered dataTable" id="dataTable" width="100%"
                                        ...
                                        <tr role="row">
                                            <th class="sorting_asc" tabindex="0" aria-controls="dataTable" rowspan="1"
                                                ...
                                                style="width: 100px;">Name of Meal
                                            </th>
                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                                colspan="1" aria-label="Position: activate to sort column ascending"
                                                style="width: 100px;">Meal Value
                                            </th>
                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                                colspan="1" aria-label="Office: activate to sort column ascending"
                                                style="width: 100px;">Vendor Name
                                            </th>
                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                                colspan="1" aria-label="Age: activate to sort column ascending"
                                                style="width: 100px;">Meals Origin
                                            </th>
                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                                colspan="1" aria-label="Start date: activate to sort column ascending"
                                                style="width: 100px;">Meals Type
                                            </th>
                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
